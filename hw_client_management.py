...
if __name__ == '__main__':
    ...
    with psycopg2.connect(database="client_management", user="postgres", password='nehgjlrfa') as conn:
        with conn.cursor() as cur:
            ...
            pprint(find_client(cur, "Иван", "Васильев",
                                '123@outlook.com'))

            print('Найденный клиент по имени, фамилии, телефону и email:')
            pprint(find_client(cur, 'Алексей', 'Алексеев',
                                'alex@outlook.com', '79997776655'))
